...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/front/sort.js"></script>
                            ...
                            <li class="data-item-li">
                                <div class="to-big">
                                    <a href="${pageContext.request.contextPath}/detail?goodsid=${goods.goodsid}">
                                        <img src="${pageContext.request.contextPath}/shopImage/${goods.imagePaths[0].path}" width="260px" height="260px" alt=""/>
                                    </a>
                                </div>
                                <p class="text-right">
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-lg">
                                    ...
                                    <c:if test="${pageInfo.hasPreviousPage}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/category?page=${pageInfo.prePage}" aria-label="Previous">
                                    ...
                                    <c:forEach items="${pageInfo.navigatepageNums}" var="pageNums">
                                        <c:if test="${pageNums == pageInfo.pageNum}">
                                            <li class="active"><a href="${pageContext.request.contextPath}/category?page=${pageNums}">${pageNums}</a></li>
                                        </c:if>
                                        <c:if test="${pageNums != pageInfo.pageNum}">
                                            <li><a href="${pageContext.request.contextPath}/category?page=${pageNums}">${pageNums}</a></li>
                                        </c:if>
                                    </c:forEach>

                                    <c:if test="${pageInfo.hasNextPage}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/category?page=${pageInfo.nextPage}" aria-label="Next">
