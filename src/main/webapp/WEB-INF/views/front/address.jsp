...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/front/address.js"></script>
    <style>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="parentModal">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveAddr" value="${pageContext.request.contextPath}">保存</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="insert-addr" tabindex="-1" role="dialog" aria-labelledby="myModalLabelInsert">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="parentModalInsert">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" id="insertAddr" value="${pageContext.request.contextPath}">保存</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="mdl-grid demo-content" id="parent">
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                ...
                <div class="mdl-card__actions mdl-card--border">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="templatemo-blue-button finish-btn" name="deleteAddr" value="${pageContext.request.contextPath}"><h5>删除地址</h5></button>
                </div>
            </div>
        </div>
</c:forEach>
